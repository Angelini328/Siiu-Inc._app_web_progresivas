...
<body>
    ...
    <body background ="configuraciones/imagenes/h.jpg">

    <div class="container p-5 my-5 text-white">
        <div class="card-group">
            <div class="card border" style="margin-right: 5px;">
                <center>
                    <img src="configuraciones/imagenes/1.png" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="card border">
                <center>
                    <img src="configuraciones/imagenes/2.png" style="width: 30%;" class="card-img-top" alt="...">
                    <div class="card-body">
